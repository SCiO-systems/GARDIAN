						...
						<div className="p-grid">
							...
							<div className="p-col-8 connection-chart-legend">
								<div className="p-grid">
									...
									<div className="p-col-6"><span>644,421</span> <i className="legend-arrow material-icons">arrow_drop_up</i></div>

									<div className="p-col-6"><span className="dot dot-red"></span>Offline</div>
									<div className="p-col-6">537,777 <i className="legend-arrow material-icons">arrow_drop_up</i></div>

									<div className="p-col-6"><span className="dot dot-orange"></span>Pending</div>
									<div className="p-col-6">570,099 <i className="legend-arrow material-icons">arrow_drop_up</i></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="p-grid controlpanel">
                        ...
                        <div className="p-col-6 p-lg-4">
                            <div className="switchpanel card">
                                ...
                                <InputSwitch checked={this.state.checked3} onChange={(e) => this.setState({checked3: e.value})} />
                            </div>
                        </div>
                        <div className="p-col-6 p-lg-4">
                            <div className="switchpanel card">
                                ...
                                <span className="switch-status">Stable</span>
                                <InputSwitch checked={this.state.checked4} onChange={(e) => this.setState({checked4: e.value})} />
                            </div>
                        </div>
                        <div className="p-col-6 p-lg-4">
                            <div className="switchpanel card switchpanel-off">
                                ...
                                <InputSwitch checked={this.state.checked5} disabled={true} onChange={(e) => this.setState({checked5: e.value})} />
                            </div>
                        </div>
                        <div className="p-col-6 p-lg-4">
                            <div className="switchpanel card">
                                ...
                                <span className="switch-status">Stable</span>
                                <InputSwitch checked={this.state.checked6} onChange={(e) => this.setState({checked6: e.value})} />
                            </div>
                        </div>
                        <div className="p-col-6 p-lg-4">
                            <div className="switchpanel card switchpanel-off">
                                ...
                                <span className="switch-status">Offline</span>
                                <InputSwitch checked={this.state.checked7} onChange={(e) => this.setState({checked7: e.value})} />
                            </div>
                        </div>
                        <div className="p-col-6 p-lg-4">
                            <div className="switchpanel card">
                                ...
                                <span className="switch-status">Stable</span>
                                <InputSwitch checked={this.state.checked8} onChange={(e) => this.setState({checked8: e.value})} />
                            </div>
                        </div>
                        <div className="p-col-6 p-lg-4">
                            <div className="switchpanel card">
                                ...
                                <span className="switch-status">Stable</span>
                                <InputSwitch checked={this.state.checked9} onChange={(e) => this.setState({checked9: e.value})} />
                            </div>
                        </div>
							...
							<li>
								<div className="p-grid p-nogutter">
									...
									<div className="p-col">
										...
										<span className="timeline-clock"><i className="material-icons">timer</i><span>12:30</span></span>
									</div>
								</div>
							</li>
							<li>
								<div className="p-grid p-nogutter">
									...
									<div className="p-col">
										...
										<span className="timeline-clock"><i className="material-icons">timer</i><span>14:39</span></span>
									</div>
								</div>
							</li>
							<li>
								<div className="p-grid p-nogutter">
									...
									<div className="p-col">
                                        ...
                                        <span className="timeline-clock"><i className="material-icons">timer</i><span>14:52</span></span>
									</div>
								</div>
							</li>
							<li>
								<div className="p-grid p-nogutter location">
									...
									<div className="p-col">
										...
										<span className="timeline-clock"><i
											className="material-icons">timer</i><span>16:24</span></span>
									</div>
								</div>
							</li>
						</ul>
