            ...
            <div className="p-grid">
                ...
                <div className="p-col-12">
                    <div className="card">
                        ...
                        <DataView value={this.state.dataViewValue} filterBy="brand" itemTemplate={this.dataViewItemTemplate} layout={this.state.layout}
                ...
                <div className="p-col-12">
                    <div className="card">
                        <div className="p-grid">
                            ...
                            <div className="p-col-12 p-md-6">
                                <div className="card-title">Checkbox Tree</div>
                ...
                <div className="p-col-12">
                    <div className="card">
                        <div className="card-title">Organization Chart</div>
                ...
                <div className="p-col-12">
                    <div className="card">
                        <div className="card-title">TreeTable</div>
