...
export const AppConfig = (props) => {
	...
	const onConfigButtonClick = (event) => {
		...
		props.onToggleBlockBodyScroll(true);
	}

	const onConfigCloseClick = (event) => {
		setConfigDialogActive(false)
		props.onToggleBlockBodyScroll(false);
	}
	...
	return (
		<React.Fragment>
			...
			{configDialogActive && <div className="layout-config-mask" />}
		</React.Fragment>
	);
}